...
> Warning! Do not try to update the Autofac NuGet package. This might cause issues when building the solution. For some reason the latest version (4.9 at the time of writing) causes ILMerge to fail.
